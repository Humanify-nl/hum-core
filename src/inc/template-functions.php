...
include_once( get_template_directory() . '/inc/template-functions/preview.php' );
include_once( get_template_directory() . '/inc/template-functions/archive.php' );
include_once( get_template_directory() . '/inc/template-functions/related-posts.php' );
include_once( get_template_directory() . '/inc/template-functions/related-pages.php' );
include_once( get_template_directory() . '/inc/template-functions/social-links.php' );
include_once( get_template_directory() . '/inc/template-functions/shapes.php' );
