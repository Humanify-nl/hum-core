...
function acf_load_preview_type_select_choices( $field ) {
    ...
    $field['choices'] = [
      ...
      'preview-type-image' => 'Image (img, title)',
...
add_filter('acf/load_field/name=preview_type_portfolio', 'acf_load_preview_type_select_choices');
add_filter('acf/load_field/name=preview_type_portfolio_rel', 'acf_load_preview_type_select_choices');
...
function acf_load_preview_page_type_choices( $field ) {
    ...
    $field['choices'] = [
      'preview' => 'Default (img, title, excerpt)',
      'preview-type-image' => 'Image (img, title)',
      'preview-type-link' => 'Link (title)',
      'preview-type-list' => 'List (img left of title & excerpt)',
