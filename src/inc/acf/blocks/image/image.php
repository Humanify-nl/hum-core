...
function hum_render_image_block( $block, $content = '', $is_preview = false ) {
  ...
  $image_enable_gif = get_field( 'image_enable_gif' );
  if ( $image_enable_gif ) {
    $className .= ' is-gif';
  }
  ...
  */
  ...
  // Editor preview
    ...
    echo '<figure class="'. esc_attr($className) .'">';
      ...
      get_template_part( 'inc/acf/blocks/image/image-template' );
...
add_action( 'acf/init', 'hum_init_image_block' );
